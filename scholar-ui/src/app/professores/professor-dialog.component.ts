    ...
    <mat-dialog-content>
      <div class="dialog-icon">
        ...
        <div class="dialog-title-text">
          <h2>{{ data ? 'Editar' : 'Novo' }} Professor</h2>
          <p>{{ data ? 'Atualize os dados do professor' : 'Preencha os dados para cadastrar' }}</p>
        </div>
      </div>
      ...
      <mat-form-field appearance="outline" class="full-width">
        ...
        <input matInput [(ngModel)]="professor.titulacao" required placeholder="Ex: Doutorado em Ciencia da Computacao">
      </mat-form-field>
    </mat-dialog-content>
