...
import com.scholar.subject.service.DisciplinaService;
...
public class DisciplinaController {
    ...
    public ResponseEntity<DisciplinaResponseDTO> create(@Valid @RequestBody DisciplinaRequestDTO dto) {
    ...
    public ResponseEntity<DisciplinaResponseDTO> update(@PathVariable Long id, @Valid @RequestBody DisciplinaRequestDTO dto) {
